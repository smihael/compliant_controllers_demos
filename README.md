...
This package contains FR3/Panda, FR3 Gazebo, UR Gazebo, and LBR/IIWA Gazebo launch files plus the controller YAML and profile files needed by those demos. The reusable controller wrapper launch remains in `compliant_controllers`.
